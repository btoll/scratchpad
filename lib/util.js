...
var exports = module.exports = {},
    ...
    curl = new Curl(),
    getNotefile, makeRequest, writeFile, notefile;

var add = function (notefile, field) {
    var json;

    if (fs.existsSync('.notefilerc')) {
        getNotefile(function (json) {
...
getNotefile = exports.getNotefile = function (callback) {
            ...
            getNotefile(function (json) {
                ...
                inquirer.prompt([{
                    ...
                    inquirer.prompt([{
                        type: 'list',
                        name: 'noteserver',
                        message: 'Please choose the noteserver to which the request should be sent:',
                        choices: choices
                    }], function (answers) {
