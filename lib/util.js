...
(() => {
    ...
    let fs = require('fs'),
        ...
        osenv = require('osenv'),
        Scratchpad, add, remove, locateConfigFile, writeConfigFile, writeScratchpad;
    ...
    add = (() => {
        ...
        return (newEntry, field) => {
            return Scratchpad.getConfigFile().then((res) => {
    ...
    remove = (() => {
        ...
        return (scratchpad, field) => {
            Scratchpad.getConfigFile().then((res) => {
                let json = JSON.parse(res.data),
    ...
    Scratchpad = {
        ...
        catScratchpad: (() => {
            let read = (scratchpad) => {
                return new Promise((resolve, reject) => {
                    let readable = fs.createReadStream(scratchpad),
                        arr = [];
                        ...
                        inquirer.prompt([{
                            ...
                            read(scratchpad).then((data) => {
                                if (answers.encrypted) {
                                    ...
                                    jcrypt.stream(scratchpad, null, ['--decrypt']).catch(console.log);
                                } else {
                                    console.log(data);
                                }
                            });
                ...
                if (!scratchpad) {
                    Scratchpad.getConfigFile().then((res) => {
                        ...
                        inquirer.prompt([{
                            ...
                            when: (answers) => {
                                answers.newScratchpad = true;
                                return answers.scratchpad === 'other';
                            }
                        }, {
                            type: 'list',
                            name: 'encrypted',
